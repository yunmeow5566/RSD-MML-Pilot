...
- Students can analyze a real world system and identify integration points with design choices.
- Students can revise project scope and planning and finalize their feature lists for final projects.

## Group Exercises
We might have two options. For classes with mixed programming experience, we can have:
- Developer: this role should be a student with at least one year of programming experience.
- Product manager
- Target user

For students working on machine learning projects, we might adjust the roles to:
- Front-end developer
